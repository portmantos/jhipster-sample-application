...
import com.mycompany.portmantos.domain.Job;
import com.mycompany.portmantos.repository.JobRepository;
...
/**
 * REST controller for managing {@link com.mycompany.portmantos.domain.Job}.
 */
@RestController
@RequestMapping("/api")
@Transactional
